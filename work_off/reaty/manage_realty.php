...
?>
<div class="d-flex justify-content-end mb-2"><a href="officer.php?p=p5_add_realty" class = "btn btn-success">เพิ่มอสังหาริมทรัพย์ <i class="fas fa-plus-circle"></i></a></div>
...
<div class="card">
    ...
    <div class="card-body bg-light">
                ...
                ?>
                    ...
                    <a href="officer.php?p=p4&del_id=<?php echo $num['id']; ?>" class="btn btn-danger text-light">ลบ <i class="fas fa-trash-alt"></i></a>
