...
?>
                ...
                <div class="card">
                    <div class="card-header ">
                        <h3 class="text-center"><b><i class="fas fa-newspaper text-primary"></i> ข่าวประชาสัมพันธ์ทั้งหมด</b></h3>
                    </div>
                    <div class="card-body pt-4">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div><p class="d-inline text-secondary font-weight-light">ผู้เขียนข่าวโดย คุณ, <?php echo $num['news_author']; ?> > โพสต์เมื่อ : <?php echo $num['date_create']; ?></p> </div>
