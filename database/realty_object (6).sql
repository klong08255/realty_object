...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2021 at 10:08 PM
...
(5, 'xxx/xxx m.x t.xxxx a.xxxx j.xxxx', 234, 2808, 100, 100, 13, 4, 1, 2, 'อาศัย', '104', '4.5', 100, 100, 100, 'DSGERH555SD', '2021-04-19', '2021-04-19', 100, 'full', '3408');
...
INSERT INTO `people_rent` (`id_rent`, `id_data_build`, `name`, `age`, `nationality`, `nationality2`, `address`, `phone_number`, `id_card`, `brithday`, `status_pay`, `datestart_rent`, `datestop_rent`, `status_rent`) VALUES
(14, 5, 'จิรพัฒน์ มีด้วง', 23, 'ไทย', 'ลาว', 'xxx x.xxx x.xxx x.xxx x.xxx', '0888888888', '1689778888888', '2021-04-19', 'ชำระแล้ว', '2021-04-16', '2021-04-20', 'เช่าอยู่');
...
--
ALTER TABLE `data_build`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับที่', AUTO_INCREMENT=6;
...
--
ALTER TABLE `people_rent`
  MODIFY `id_rent` int(5) NOT NULL AUTO_INCREMENT COMMENT 'idตาราง', AUTO_INCREMENT=15;
