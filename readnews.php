        ...
        ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-1">
                        <div>
                        <p class="d-inline text-secondary font-weight-light" style="font-size:0.8rem;">ผู้เขียนข่าวโดย คุณ, <?php echo $num['news_author']; ?> > โพสต์เมื่อ : <?php echo $num['date_create']; ?></p>
                        </div>
