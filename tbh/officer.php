                    ...
                    <div id="layoutSidenav_nav">
                        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" >
                            <div class="sb-sidenav-menu">
                                <div class="nav">
                                    <a class="nav-link collapsed" href="officer.php?p=p1"  data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                        <div class="sb-nav-link-icon "><i class="fas fa-newspaper"></i></div>
                                        จัดการข่าว
                                    </a>
                                    <a class="nav-link collapsed" href="officer.php?p=p3"  data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                        <div class="sb-nav-link-icon "><i class="fas fa-user-edit"></i></div>
                                        จัดการข้อมูลผู้เช่า
                                    </a>           
                                    <a class="nav-link collapsed" href="officer.php?p=p5"  data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
